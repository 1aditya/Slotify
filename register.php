        ...
        <div id ="loginContainer">
            ...
            <div id = "inputContainer">
                ...
                <p>
                    ...
                    <input id = "username" name ="username" type="text" placeholder ="e.g. Baart Simpson" value="<?php getInputValue('username') ?>"  required>
                </p>
                <p>
                    <?php echo $account->getError(Constants::$firstNameCharachters); ?>
                    <label for="firstName">First name</label>
                    <input id = "firstName" name ="firstName" type="text" placeholder ="e.g. Baart" value="<?php getInputValue('firstName') ?>"  required>
