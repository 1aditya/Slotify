<?php
	class Account {
		...
		private function insertUserDetails($un, $fn, $ln, $em, $pw) {
			...
			$result = pg_query($this->con, "INSERT INTO users(username,firstname,lastname,email,password,signupdate,profilepic) VALUES ( '$un', '$fn', '$ln', '$em', '$encryptedPw', '$date', '$profilePic')");
